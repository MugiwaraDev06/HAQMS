...
import { Activity, ShieldAlert, MonitorPlay, Users, CalendarDays, ArrowRight } from '@/components/common/Icons';
  ...
  return (
    <div className="flex flex-col min-h-screen justify-between py-12 px-6 lg:px-8">
      <div className="max-w-4xl mx-auto w-full text-center mt-12 sm:mt-20">
        ...
        <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight bg-gradient-to-r from-teal-600 to-emerald-500 text-gradient">
          HAQMS
        </h1>
